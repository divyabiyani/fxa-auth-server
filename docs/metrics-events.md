...
|`email.sent`|A confirmation/verification email has been sent to a user.|
|`email.clicked`|The link inside a confirmation/verification email has been clicked.|
...
* Expiry time
  for metricsContext data in memcached
